###########################################################################
## Makefile generated for component 'ControllerLogic'. 
## 
## Makefile     : ControllerLogic.mk
## Generated on : Tue Aug 12 20:13:35 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ControllerLogic
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ControllerLogic
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ControllerLogic_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ControllerLogic -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ControllerLogic_ert_rtw/ControllerLogic.cpp $(START_DIR)/ControllerLogic_ert_rtw/ControllerLogic_data.cpp

MAIN_SRC = $(START_DIR)/ControllerLogic_ert_rtw/ert_main.cpp
...
OBJS = ControllerLogic.o ControllerLogic_data.o
...
%.o : $(START_DIR)/ControllerLogic_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ControllerLogic_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ControllerLogic_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControllerLogic_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControllerLogic_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ControllerLogic.o : $(START_DIR)/ControllerLogic_ert_rtw/ControllerLogic.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ControllerLogic_data.o : $(START_DIR)/ControllerLogic_ert_rtw/ControllerLogic_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ControllerLogic_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
